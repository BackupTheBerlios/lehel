...
>     status             <- make tmpf $ ["-O0", "-fglasgow-exts", "-package plugins", "-framework GMP", "-framework-path/Library/Frameworks"] ++ args
...
>            sequence $ replicate 3 $ liftM chr (getStdRandom (randomR (97,122)))
